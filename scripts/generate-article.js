...
// 絵文字・特殊Unicode文字を除去するフィルター
function stripEmoji(str) {
  return str.replace(/[\u{1F000}-\u{1FFFF}]|[\u{2600}-\u{27BF}]|[\u{FE00}-\u{FE0F}]|[\u{1F900}-\u{1F9FF}]|[\u{200D}]|[\u{20E3}]|[\u{E0020}-\u{E007F}]|[\u{2700}-\u{27BF}]|[\u{2300}-\u{23FF}]|[\u{2B50}]|[\u{2B55}]|[\u{231A}-\u{231B}]|[\u{25AA}-\u{25AB}]|[\u{25FB}-\u{25FE}]|[\u{00A9}\u{00AE}]|[\u{2122}]|[\u{203C}\u{2049}]|[\u{2139}]|[\u{2194}-\u{2199}]|[\u{21A9}-\u{21AA}]|[\u{2934}-\u{2935}]|[\u{25B6}\u{25C0}]|[\u{2660}-\u{2668}]|[\u{267B}\u{267F}]|[\u{2693}]|[\u{26A1}]|[\u{26AA}-\u{26AB}]|[\u{26BD}-\u{26BE}]|[\u{26C4}-\u{26C5}]|[\u{26D4}]|[\u{26EA}]|[\u{26F2}-\u{26F3}]|[\u{26F5}]|[\u{26FA}]|[\u{26FD}]|[\u{2702}]|[\u{2708}]|[\u{2709}]|[\u{270A}-\u{270D}]|[\u{270F}]|[\u{2712}]|[\u{2714}]|[\u{2716}]|[\u{271D}]|[\u{2721}]|[\u{2728}]|[\u{2733}-\u{2734}]|[\u{2744}]|[\u{2747}]|[\u{274C}]|[\u{274E}]|[\u{2753}-\u{2755}]|[\u{2757}]|[\u{2763}-\u{2764}]|[\u{2795}-\u{2797}]|[\u{27A1}]|[\u{27B0}]/gu, '');
}
...
- 絵文字・顔文字・特殊記号（Unicode絵文字）は絶対に使用禁止。例: ✨🔥💪😊👍❤️🎉🌟⭐️📝🍽️♨️💆等は全て禁止。ASCII文字と日本語のみ使用すること
      ...
      (res) => {
        ...
        res.on('end', () => {
          try {
            ...
            parsed.title = stripEmoji(parsed.title);
            parsed.content = stripEmoji(parsed.content);
            resolve(parsed);
          } catch (e) {
            reject(e);
          }
